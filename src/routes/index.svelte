	...
	<section id="about" class="lg:my-24 md:my-20 my-10">
		<div class="flex flex-col items-center justify-between gap-10 md:flex-row">
			...
			<div class="flex-1">
				<img
					class="rounded-2xl"
					src="https://scontent-iad3-2.xx.fbcdn.net/v/t1.6435-9/71036419_10214649890945289_3604821770143531008_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=8631f5&_nc_ohc=lUwoSLgJ4bYAX9l9Vrl&_nc_ht=scontent-iad3-2.xx&oh=00_AT9uvK6_fVmyRMNCsxf0jSw7RE-gn4cm0EyvfIeKY3vTHQ&oe=62925228"
					alt="group photo from folks playing kickball"
				/>
			</div>
		</div>
	</section>
		...
		<div class="flex flex-col items-center justify-between gap-10 md:flex-row">
			<div class="flex-1">
				...
				<ul class="grid md:grid-cols-3 gap-4 mt-5">
					<li>
						<a class="border rounded-lg p-4 block hover:bg-slate-50 hover:underline" href="https://www.facebook.com/groups/DurhamQueerKickball" target="_blank"
							>Kickball</a
						>
					</li>
					<li>
						<a class="border rounded-lg p-4 block hover:bg-slate-50 hover:underline" href="https://www.facebook.com/groups/446538442593552" target="_blank"
							>Soccer</a
						>
					</li>
					<li>
						<a class="border rounded-lg p-4 block hover:bg-slate-50 hover:underline" href="https://www.facebook.com/groups/DurmQueerBball/" target="_blank"
							>Basketball</a
						>
					</li>
					<li>
						<a class="border rounded-lg p-4 block hover:bg-slate-50 hover:underline" href="https://www.facebook.com/groups/2198858146817694/" target="_blank"
							>Ultimate</a
						>
					</li>
					<li>
						<a class="border rounded-lg p-4 block hover:bg-slate-50 hover:underline" href="https://www.facebook.com/groups/2227800064187253/" target="_blank"
							>Run club</a
						>
					</li>
					<li>
						<a class="border rounded-lg p-4 block hover:bg-slate-50 hover:underline" href="https://www.facebook.com/groups/durhamqueertennis" target="_blank"
							>Tennis</a
						>
					</li>
				</ul>
