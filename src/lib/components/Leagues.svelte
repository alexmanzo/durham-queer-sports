<section id="leagues" class="lg:my-24 md:my-20 my-10">
	<div class="flex flex-col items-center justify-between gap-10 md:flex-row">
		<div class="flex-1">
			<h2 class="text-3xl mb-5 font-serif font-medium tracking-wide">Leagues</h2>
